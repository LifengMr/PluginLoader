...
public class ReflectHelper {
    ...
    public static <T> T invoke(Method method, Object target, Object[] args) {
        ...
        try {
            ...
            JLog.i(TAG, "invoke..IllegalAccessException e=" + e.getMessage() + ",method=" + method.getName());
        } catch (InvocationTargetException e) {
            JLog.i(TAG, "invoke..InvocationTargetException e=" + e.getMessage() + ",method=" + method.getName());
        }
        return result;
    }
