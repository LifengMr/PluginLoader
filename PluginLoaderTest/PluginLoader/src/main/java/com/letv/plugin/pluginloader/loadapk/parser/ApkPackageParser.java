package com.letv.plugin.pluginloader.loadapk.parser;
...
import com.letv.plugin.pluginloader.loadapk.compat.AssetManagerCompat;
...
public class ApkPackageParser {
    ...
    public ApkPackageParser(String packagePath, String packageName) {
        mArchiveSourcePath = packagePath;
    ...
    public boolean parsePackage() {
        ...
        try {
            assmgr = AssetManagerCompat.newInstance();
            int cookie = AssetManagerCompat.addAssetPath(assmgr, mArchiveSourcePath);
            if(cookie != 0) {
        ...
        res = new Resources(assmgr, Apker.ins().host().getResources().getDisplayMetrics(), null);
            ...
            while ((type=parser.next()) != XmlResourceParser.END_DOCUMENT) {
                ...
                if (tagName.equals("application")) {
                    ApplicationInfo app = new ApplicationInfo(
                            Apker.ins().host().getApplicationInfo());
